import { computeViewportAlignment, getTimeScaleForZoom, DAY_THRESHOLD, HOUR_THRESHOLD } from '../../core/utils/layout'
 ...
 * Base band (months): 32px; days add up to +24px after DAY_THRESHOLD; hours add up to +24px after HOUR_THRESHOLD.
 */
...
export function computeDateHeaderViewModel(params: DateHeaderParams): DateHeaderViewModel {
  ...
  const alignment = computeViewportAlignment({ LEFT_MARGIN: leftMarginCss, DAY_WIDTH: dayWidthCss } as any, viewport.x || 0)
