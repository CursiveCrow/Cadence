/**
 * Electron implementation of PlatformPort using IPC via preload's window.api.
 */
...
import { IPC_CHANNELS, DialogOpenFileRequest, DialogOpenFileResponse, SaveFileRequest, SaveFileResponse, AppGetVersionResponse, DialogMessageBoxOptions, DialogMessageBoxResponse } from '../../infrastructure/platform/contracts'

export class ElectronPlatformServices implements PlatformPort {
