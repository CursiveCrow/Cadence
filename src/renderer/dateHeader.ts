import { getTimeScaleForZoom, DAY_THRESHOLD, HOUR_THRESHOLD } from './timeScale'
import { worldDaysToScreenX } from './timelineMath'
...
export function computeDateHeaderViewModel(params: DateHeaderParams): DateHeaderViewModel {
    ...
    while (true) {
        ...
        const xScreen = worldDayToScreenXCss(dayIndex)
