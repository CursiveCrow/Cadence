/**
 * WGSL helper functions shared by GPU time grid shader.
 */
...
// Convert screen x to world-space days using current uniforms
...
// Return distances in pixels to the nearest minor and major grid lines
